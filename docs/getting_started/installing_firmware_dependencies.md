...
If you want to get started with building the raspberry pi pico firmware, a good idea would be to try to flash Pi Pico with the example file. Note that you would need to build it first:
```sh
